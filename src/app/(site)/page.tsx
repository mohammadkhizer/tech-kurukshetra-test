...
export const metadata = buildPageMeta({
  title: "TECH KURUKSHETRA 2027 | India's Premier Tech Festival",
  description:
    'Two-day national tech festival at UCPIT, SVGU Ahmedabad, January 2027. 12 competitive arenas: hackathon, coding, gaming, robotics, and more. Free registration open.',
  path: '/',
});
  ...
  return (
    <>
      ...
      <Script
        id="festival-schema"
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(FESTIVAL_SCHEMA) }}
      />
      <Script
        id="faq-schema"
        type="application/ld+json"
